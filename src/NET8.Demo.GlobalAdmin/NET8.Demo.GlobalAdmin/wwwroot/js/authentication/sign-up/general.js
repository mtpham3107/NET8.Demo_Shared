...
function SignupGeneral(localizer) {
    ...
    const validator = FormValidation.formValidation(form, {
        fields: {
            "firstName": {
                validators: {
                    notEmpty: {
                        message: localizer['Register.FirstNameRequired'],
                    }
                }
            },
            "lastName": {
                validators: {
                    notEmpty: {
                        message: localizer['Register.LastNameRequired'],
                    }
                }
            },
            email: {
            ...
            toc: {
                validators: {
                    notEmpty: {
                        message: localizer['Register.AcceptTerm'],
                    }
                }
            }
        },
